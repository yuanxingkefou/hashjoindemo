...
import static com.mq.presto.source.BlockUtil.calculateBlockResetSize;
...
{
    private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(LongArrayBlockBuilder.class).instanceSize();
