...
import static com.mq.presto.source.PageBuilderStatus.DEFAULT_MAX_PAGE_SIZE_IN_BYTES;
...
public class PageBuilder
{
    ...
    private final List<IntegerType> types;
     ...
     */
    public PageBuilder(List<IntegerType> types)
    {
        this(DEFAULT_INITIAL_EXPECTED_ENTRIES, types);
    }

    public PageBuilder(int initialExpectedEntries, List<IntegerType> types)
    {
        this(initialExpectedEntries, DEFAULT_MAX_PAGE_SIZE_IN_BYTES, types, Optional.empty());
    }

    public static PageBuilder withMaxPageSize(int maxPageBytes, List<IntegerType> types)
    {
        return new PageBuilder(DEFAULT_INITIAL_EXPECTED_ENTRIES, maxPageBytes, types, Optional.empty());
    }

    private PageBuilder(int initialExpectedEntries, int maxPageBytes, List<IntegerType> types, Optional<BlockBuilder[]> templateBlockBuilders)
    {
    ...
    public IntegerType getType(int channel)
    {
