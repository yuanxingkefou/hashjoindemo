...
import static com.mq.presto.source.BlockUtil.checkArrayRange;
import static com.mq.presto.source.BlockUtil.checkValidPosition;
import static com.mq.presto.source.BlockUtil.checkValidPositions;
import static com.mq.presto.source.BlockUtil.checkValidRegion;
import static com.mq.presto.source.BlockUtil.countUsedPositions;
import static com.mq.presto.source.BlockUtil.internalPositionInRange;
import static com.mq.presto.source.DictionaryId.randomDictionaryId;
...
public class DictionaryBlock
        implements Block
{
    private static final int INSTANCE_SIZE = (int) (ClassLayout.parseClass(DictionaryBlock.class).instanceSize() + ClassLayout.parseClass(DictionaryId.class).instanceSize());
