...
public class LookupJoinPageBuilder
{
    ...
    public LookupJoinPageBuilder(List<IntegerType> buildTypes)
    {
     ...
     */
    public void appendRow(JoinProbe probe, JoinHash joinHash, long joinPosition)
    {
        // probe side
        ...
        joinHash.appendTo(joinPosition,buildPageBuilder, 0);
    }
