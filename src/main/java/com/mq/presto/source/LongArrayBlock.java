...
import static com.mq.presto.source.BlockUtil.compactArray;
...
public class LongArrayBlock
        implements Block
{
    private static final int INSTANCE_SIZE = (int) ClassLayout.parseClass(LongArrayBlock.class).instanceSize();
